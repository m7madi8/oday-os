...
class DocumentTransformer extends EntityTransformer
{
    ...
    public function transform(Document $document)
    {
        return  [
            ...
            'project_id' => $this->encodePrimaryKey($document->resolvedProjectId()),
            'client_id' => $this->encodePrimaryKey($document->resolvedClientId()),
            'category' => (string) ($document->custom_value1 ?? ''),
