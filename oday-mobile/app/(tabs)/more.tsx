  ...
  return (
    <ScreenShell title="المزيد">
      <View style={styles.content}>
        ...
        <Item icon={<Files color={C.limeDeep} size={20} />} label="ملفات المشاريع" onPress={() => router.push('/documents')} />
        <Item icon={<Sparkles color={C.limeDeep} size={20} />} label="المساعد الذكي (قريبًا)" onPress={() => router.push('/ai')} />
