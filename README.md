...
هذا المشروع ملك **عدي أبو ضحى** (Oday Abu Doha Architects). الاسم والاستخدام الداخلي واللوحة المحاسبية تعود إليه.

النواة التقنية مبنية على Invoice Ninja v5 وفق رخصة Elastic License، مع تخصيص الهوية والاستخدام لمكتب عدي.
...
See [LICENSE](LICENSE) for details.#   o d a y - o s  
 